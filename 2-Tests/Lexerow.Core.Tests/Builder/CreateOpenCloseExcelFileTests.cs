...
public sealed class CreateOpenCloseExcelFileTests
{
    ...
    public void OpenExcelFileNameNullFail()
    {
        ...
        ExecResult execResult = core.ProgBuilder.CreateInstrOpenExcelParamConst("file", null);
    ...
    public void OpenExcelObjectWrong()
    {
        ...
        ExecResult execResult = core.ProgBuilder.CreateInstrOpenExcelParamConst("fi<!ù$=le", fileName);
    ...
    public void OpenExcelFileNameTwoTimesFail()
    {
        ...
        // 2nd time!
        execResult = core.ProgBuilder.CreateInstrOpenExcelParamConst("file2", fileName);
        Assert.IsNotNull(execResult);
        Assert.IsFalse(execResult.Result);

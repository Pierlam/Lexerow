...
public class ExecInstrManyForEachRowIfThenTests
{
    ...
    public void TestForEachRow2IfThen()
    {
        ...
        //-- A.Cell<10 
        InstrCompCellVal exprCompIf = core.Builder.CreateInstrCompCellVal(0, InstrCompCellValOperator.LesserThan, 10);
        ...
        //-- A.Cell>50 
        exprCompIf = core.Builder.CreateInstrCompCellVal(0, InstrCompCellValOperator.GreaterThan, 50);

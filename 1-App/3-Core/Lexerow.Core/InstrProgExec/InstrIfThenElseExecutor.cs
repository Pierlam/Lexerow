...
public class InstrIfThenElseExecutor
{
    ...
    {
        _logger.Log(ActivityLogLevel.Debug, "InstrIfThenElseExecutor.ExecInstrIfThenElse", string.Empty);
        ...
        if (ctx.PrevInstrExecuted != null)
        {
            ...
            if (instrIf != null)
            {
                _logger.Log(ActivityLogLevel.Debug, "InstrIfThenElseExecutor.ExecInstrIfThenElse", "Prev was If, push Then block instr");
                // execute then instr
        ...
        _logger.Log(ActivityLogLevel.Debug, "InstrIfThenElseExecutor.ExecInstrIfThenElse", "Push If instr");
        return true;
    }
    ...
    {
        _logger.Log(ActivityLogLevel.Debug, "InstrIfThenElseExecutor.ExecInstrIf", string.Empty);
        ...
        if (ctx.PrevInstrExecuted != null)
        {
            ...
            if (instrComparison != null)
            {
                ...
                _logger.Log(ActivityLogLevel.Debug, "InstrIfThenElseExecutor.ExecInstrIf", "Prev was If comparison, result: " + instrIf.Result.ToString());
        ...
        if (instrIf.InstrBase.InstrType == InstrType.Comparison)
        {
            ...
            _logger.Log(ActivityLogLevel.Debug, "InstrIfThenElseExecutor.ExecInstrIf", "Run If comparison");
            return true;
        }
    ...
    {
        _logger.Log(ActivityLogLevel.Debug, "InstrIfThenElseExecutor.ExecInstrThen", string.Empty);

...
public class ScriptParserIfAndOrThenTests
{
    ...
    ///	OnExcel "file.xlsx"
    ///   ForEach Row
    ///     If A.Cell >10 And B.Cell< 20 And C.Cell =17 Then D.Cell=25
    ///   Next
    /// End OnExcel
    /// </summary>
    [TestMethod]
    public void OnExcelIfAndAndOk()
    {
        ...
        line.AddTokenName(numLine++, 1, "If");
        TestTokensBuilder.BuidColCellOperInt(numLine++, line, "A", ">", 10);
        line.AddTokenName(numLine, 5, "And");
        TestTokensBuilder.BuidColCellOperInt(numLine++, line, "B", "<", 20);
        line.AddTokenName(numLine, 10, "And");
        TestTokensBuilder.BuidColCellOperInt(numLine++, line, "C", "=", 17);
        line.AddTokenName(numLine, 15, "Then");
        TestTokensBuilder.BuidColCellEqualInt(numLine++, line, "D", 17);
        scriptTokens.Add(line);
        ...
        InstrBoolExpr instrBoolExpr = instrIfThenElse.InstrIf.InstrBase as InstrBoolExpr;
        Assert.IsNotNull(instrBoolExpr);
        Assert.AreEqual(3, instrBoolExpr.ListOperand.Count);
        Assert.AreEqual(InstrBoolExprOperator.And, instrBoolExpr.Operator);
        ...
        // chcek the third comp instr: C=17
        instrComparison = instrBoolExpr.ListOperand[2] as InstrComparison;
        Assert.IsNotNull(instrComparison);
        instrColCellFunc = instrComparison.OperandLeft as InstrColCellFunc;
        Assert.IsNotNull(instrColCellFunc);
        Assert.AreEqual("C", instrColCellFunc.ColName);
        // =
        Assert.AreEqual(SepComparisonOperator.Equal, instrComparison.Operator.Operator);
    ...
    ///	OnExcel "file.xlsx"
    ///   ForEach Row
    ///     If A.Cell >10 And B.Cell< 20 Or C.Cell =17 Then D.Cell=25
    ///   Next
    /// End OnExcel
    /// </summary>
    [TestMethod]
    public void OnExcelIfAndOrWrong()
    {
        int numLine = 0;
        List<ScriptLineTokens> scriptTokens = new List<ScriptLineTokens>();
        ...
        line.AddTokenName(numLine, 5, "And");
        TestTokensBuilder.BuidColCellOperInt(numLine++, line, "B", "<", 20);
        line.AddTokenName(numLine, 10, "Or");
        TestTokensBuilder.BuidColCellOperInt(numLine++, line, "C", "=", 17);
        line.AddTokenName(numLine, 15, "Then");
        TestTokensBuilder.BuidColCellEqualInt(numLine++, line, "D", 17);
        scriptTokens.Add(line);
        ...
        Assert.AreEqual("Or", result.ListError[0].Param);
    }
    ...
    ///	OnExcel "file.xlsx"
    ///   ForEach Row
    ///     If A.Cell >10 And And B.Cell< 20 Then D.Cell=25
    ///   Next
    /// End OnExcel
    /// </summary>
    [TestMethod]
    public void OnExcelIfAndAndExprWrong()
    {
        int numLine = 0;
        List<ScriptLineTokens> scriptTokens = new List<ScriptLineTokens>();
        ...
        TestTokensBuilder.BuidColCellOperInt(numLine++, line, "A", ">", 10);
        line.AddTokenName(numLine, 5, "And");
        line.AddTokenName(numLine, 7, "And");
        TestTokensBuilder.BuidColCellOperInt(numLine++, line, "B", "<", 20);
        line.AddTokenName(numLine, 15, "Then");
        TestTokensBuilder.BuidColCellEqualInt(numLine++, line, "D", 17);
        scriptTokens.Add(line);
        ...
        Assert.AreEqual("And", result.ListError[0].Param);
    }

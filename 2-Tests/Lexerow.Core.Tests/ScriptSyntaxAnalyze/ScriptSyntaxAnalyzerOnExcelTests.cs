...
public class ScriptSyntaxAnalyzerOnExcelVeryShortTests
{
    ...
    /// </summary>
    [TestMethod]
    public void VeryShortOnExcelSeveralLinesOk()
    {
        List<ScriptLineTokens> script = new List<ScriptLineTokens>();
        ...
        //-ForEach Row
        lineTok = new ScriptLineTokens();
        lineTok.AddTokenName(2, 1, "ForEach");
        lineTok.AddTokenName(2, 1, "Row");
        script.Add(lineTok);
    ...
    public void VeryShortOnExcelOneLineOk()
    {
        ...
        // If A.Cell >10 Then A.Cell=10
        ScriptBuilder.BuidIfACellEq10ThenSetACell(1,lineTok);
        script.Add(lineTok);
    ...
    public void VeryShortOnExcelIfThenEndIfOk()
    {
        ...
        ScriptBuilder.BuidACellGt10(3, lineTok);
        lineTok.AddTokenName(3, 1, "Then");
        script.Add(lineTok);

        // A.Cell=10
        lineTok = new ScriptLineTokensTest();
        ScriptBuilder.BuidACellEq10(4, lineTok);
        script.Add(lineTok);

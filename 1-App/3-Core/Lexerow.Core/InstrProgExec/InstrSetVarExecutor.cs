...
public class InstrSetVarExecutor
{
    ...
    {
        _logger.Log(ActivityLogLevel.Debug, "InstrSetVarExecutor.Exec", "Token: " + instrSetVar.FirstScriptToken());
    ...
    {
        _logger.Log(ActivityLogLevel.Debug, "InstrSetVarExecutor.ExecSetToColCellFunc", "Left is InstrColCellFunc: " + instrSetVar.FirstScriptToken());
